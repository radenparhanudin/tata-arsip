                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover" id="tableDownloadSKCollective" width="100%">
                                <thead>
                                    <tr>
                                        <th>Nomor SK</th>
                                        <th>Tentang</th>
                                ...
                                <tbody>
                                	@foreach ($sk as $r)
                                		<tr>
                                            ...
                                            <div>
                                                <a href="{{ url('/download/sk/collective') . '/' . $r->id }}" target="_blank" class="btn bg-teal btn-lg waves-effect">Download SK</a>
                                            </div>
                                        </td>
	                                	</tr>
                                	@endforeach
